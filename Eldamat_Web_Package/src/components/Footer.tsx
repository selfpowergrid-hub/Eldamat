...
export default function Footer() {
    return (
        <footer className="relative bg-gradient-to-b from-[#0D2140] to-[#071428] text-white overflow-hidden">
            {/* Decorative Pattern */}
            ...
            {/* Red Accent Strip */}
            <div className="h-1 bg-gradient-to-r from-[#C41E3A] via-[#E63350] to-[#C41E3A]" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <Link href="/" className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <span className="text-2xl font-bold tracking-tight">ELDAMAT</span>
                                <span className="block text-xs text-white/60 tracking-widest uppercase">Security Services</span>
                            </div>
                        </Link>
                        ...
                        <div className="flex gap-3">
                            {['facebook', 'twitter', 'linkedin', 'instagram'].map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 rounded-lg bg-white/5 hover:bg-[#C41E3A] flex items-center justify-center transition-all duration-300 group"
                                >
                    ...
                    {/* Services Links */}
                    <div>
                        <h4 className="font-semibold text-white mb-5 text-lg">Our Services</h4>
                        <ul className="space-y-3">
                            {footerLinks.services.map((link) => (
                                <li key={link.name}>
                                    <Link href={link.href} className="text-white/60 hover:text-[#E63350] transition-colors text-sm">
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <svg className="w-5 h-5 text-[#C41E3A] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li className="flex items-center gap-3">
                                <svg className="w-5 h-5 text-[#C41E3A] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <a href="tel:+254752285595" className="text-white/60 hover:text-[#E63350] text-sm transition-colors">
                                    +254 752 285 595
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                                ...
                                <a href="mailto:eldamatsec@gmail.com" className="text-white/60 hover:text-[#E63350] text-sm transition-colors">
                                    eldamatsec@gmail.com
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2 text-white/40 text-sm">
                            ...
                            <span className="font-semibold text-[#C41E3A]">PSRA</span>
                        </div>
                    </div>
                </div>
            </div>
